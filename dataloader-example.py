##### using DatSet and DataLoader for batching #####
...
# Datasets need at minimum an init, getitem and length method
...
#define a tensor transform, transforms must have a call method.
class ToTensor:
